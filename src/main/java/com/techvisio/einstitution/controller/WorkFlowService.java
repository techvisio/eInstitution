...
public class WorkFlowService {
	...
	public WorkFlowFieldMapping getWorkFlowFieldMappingByWorkFlowStepId(@PathVariable String workFlowStepId){
		logger.info("{} WorkFlowService Calling getWorkFlowFieldMappingByWorkFlowStepId method by : workFlowStepId : {}",this.getClass().getName(), workFlowStepId);
	...
	public WorkFlowFieldMapping getWorkFlowFieldMappingByWorkFlowId(@PathVariable String workFlowId){
		logger.info("{} WorkFlowService Calling getWorkFlowFieldMappingByWorkFlowId method by : workFlowId : {}",this.getClass().getName(), workFlowId);
	...
	public void addWorkFlowFieldMapping(@RequestBody WorkFlowFieldMapping workFlowFieldMapping){
		logger.info("{} WorkFlowService Calling addWorkFlowFieldMapping method  : workFlowId workFlowStepId : {}",this.getClass().getName(), workFlowFieldMapping.getWorkFlowId()+ workFlowFieldMapping.getWorkFlowStepId());
	...
	public void updateWorkFlowFieldMapping(@RequestBody WorkFlowFieldMapping workFlowFieldMapping){
		logger.info("{} WorkFlowService Calling updateWorkFlowFieldMapping method  : workFlowId workFlowStepId : {}",this.getClass().getName(), workFlowFieldMapping.getWorkFlowId()+ workFlowFieldMapping.getWorkFlowStepId());
	...
	public void deleteWorkFlowFieldMapping(@PathVariable String workFlowStepId){
		logger.info("{} WorkFlowService Calling deleteWorkFlowFieldMapping method by : workFlowStepId : {}",this.getClass().getName(), workFlowStepId);
