...
//			MasterData bean=new MasterData(branch.getPymntCritriaId().toString(), branch.getBranchName(), branch.getCourseId().toString());
//			masterData.add(bean);
//		}
//		return masterData;
//	}
...
//			MasterData bean=new MasterData(category.getPymntCritriaId().toString(), category.getCategoryName());
//			masterData.add(bean);
//		}
//		return masterData;
//	}
...
//			MasterData bean=new MasterData(qualification.getPymntCritriaId().toString(), qualification.getQulaifyingExam());
//			masterData.add(bean);
//		}
//		return masterData;
//	}
...
//			MasterData bean=new MasterData(quotaCode.getPymntCritriaId().toString(), quotaCode.getCode());
//			masterData.add(bean);
//		}
//		return masterData;
//	}
...
//			MasterData bean=new MasterData(state.getPymntCritriaId().toString(), state.getStateName());
//			masterData.add(bean);
//		}
//		return masterData;
//	}
...
//			MasterData bean=new MasterData(subject.getPymntCritriaId().toString(), subject.getSubjectName());
//			masterData.add(bean);
//		}
//		return masterData;
//	}	
...
//			MasterData bean=new MasterData(semester.getPymntCritriaId().toString(), semester.getSemester(),semester.getCourseId().toString());
//			masterData.add(bean);
//		}
//		return masterData;
//	}	
...
//		
//		for(CasteCategory category:getCategories()){
//			categoryMap.put(category.getPymntCritriaId(), category);
//		}
//		
//		for(Branch branch:getBranchs()){
//			branchMap.put(branch.getPymntCritriaId(), branch);
//		}
//	
//		for(CodeMapping codeMapping:getCodeMapping()){
...
//		
//		for(Qualification qualification : getQualifications()){
//			qualificationMap.put(qualification.getPymntCritriaId(), qualification);
//		}
//		
//		for(QuotaCode quotaCode : getQuotaCodes()){
//			quotaCodeMap.put(quotaCode.getPymntCritriaId(), quotaCode);
//		}
//		
//		for(State state : getStates()){
//			stateMap.put(state.getPymntCritriaId(), state);
//		}
//		
//		for(Subject subject : getSubjects()){
//			subjectMap.put(subject.getPymntCritriaId(), subject);
//		}
//		
//		for(Wing wing : getWing()){
